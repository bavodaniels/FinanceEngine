...
class NLookBackStandardDeviationTest {

    @Mock
    private PriceRepository priceRepository;

    private NLookBackStandardDeviation standardDeviation;
    ...
    void setUp() {
        ...
        standardDeviation = new NLookBackStandardDeviation(lookback, priceRepository, asset);
    }
    ...
    void calculate_WithNormalData_ReturnsExpectedStandardDeviation() {
        ...
        LocalDate fromDate = testDate.minusDays(lookback);
        
        when(priceRepository.getPricesFromDateUpUntilDate(asset, fromDate, testDate))
                .thenReturn(prices);
