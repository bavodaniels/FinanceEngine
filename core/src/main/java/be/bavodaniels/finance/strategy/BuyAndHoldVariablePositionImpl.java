...
//
//
//public class BuyAndHoldVariablePositionImpl implements Strategy {
...
//    );
//
//    public BuyAndHoldVariablePositionImpl(PriceRepository priceRepository,
//                                          String asset,
//                                          int multiplier,
...
//        this.stddev = new ExponentialStandardDeviation(priceRepository, asset);
////        this.stddev = new NLookBackStandardDeviation(20, priceRepository, asset);
//    }
//
//    @Override
